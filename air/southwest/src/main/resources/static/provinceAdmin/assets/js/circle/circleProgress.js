...
(function() {
    ...
    var BACKGROUND_LINE_WIDTH = 4.0,
        CIRCLE_LINE_WIDTH = 4.0,
        PROGRESS_END_RADIUS = 16,
        PROGRESS_END_WIDTH = 52,
        PROGRESS_END_HEIGHT = 24;
    ...
    var CircleProgress = function (config) {
        ...
        this.backgroundColor = config.backgroundColor || '#296785';
        this.circleColor = config.circleColor || '#77ccf4';
        this.textColor = config.textColor || '#fff';
        this.textEnd = '';
        this.font = config.font || '14px Helvetica Neue';
        this.font1 = config.font || '30px Helvetica Neue';
        this.grade = config.grade || "优";
    ...
    CircleProgress.prototype.drawText = function () {
        var progressEndX = this.centerCoordinate;
        var progressEndY = this.centerCoordinate;
        this.ctx.beginPath();
        ...
        this.ctx.fillText(this.value, progressEndX, progressEndY-4);
        this.ctx.font = this.font;
        this.ctx.fillText(this.grade, progressEndX, progressEndY + 20);
        return this
    }
