var vm = new Vue({
	...
	methods : {
		...
		addConfig : function() {
			vm.showList = false;
			vm.title = "代码生成配置";
			var url = '/system/generator_do/getsetting.do';
			$.ajax({
				type : "POST",
				url : url,
		...
		saveOrUpdate : function() {
			var url = rootPath + "/system/generator_do/updatesetting.do";
			$.ajax({
				dataType : 'json',
				type : "POST",
				url : url,
		...
		reload : function() {
			...
			layui.use('table', function() {
                ...
                table.render({
                    ...
                    ,
                    url : rootPath + '/system/generator_do/list.do',
                    cols : [
                        [
                            {
                                type : 'checkbox'
		...
		gencode:function(){
            ...
            layui.use('layer', function() {
                ...
                layer.confirm('是否生成？', function(index) {
                    ...
                    location.href = '/system/generator_do/code.do?tables=' + roleIds+"&datasource="+$("#datasource").val();
