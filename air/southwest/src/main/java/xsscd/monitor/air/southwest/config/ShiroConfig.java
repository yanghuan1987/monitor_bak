...
import xsscd.monitor.air.southwest.core.shiro.ShiroRealm;
import xsscd.monitor.air.southwest.modules.system.filter.SysAccessControllerFilter;
...
public class ShiroConfig {
	   @Bean
	    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
		   ...
		   filterChainDefinitionMap.put("/java/superset/**","anon");
