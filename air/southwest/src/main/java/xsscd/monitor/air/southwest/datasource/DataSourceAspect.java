...
public class DataSourceAspect {
	...
	//切点
	@Pointcut("execution(* xsscd.monitor.air.southwest.modules..*.*(..)))")
	public void aspect() { }
	...
	private void before(JoinPoint point) {
        ...
        try {  
            ...
            if (m != null && m.isAnnotationPresent(EasymisDataSource.class)) {  
            	EasymisDataSource data = m.getAnnotation(EasymisDataSource.class);  
