...
@ApiModel(value = "User得实体，----》",reference = "参考")
//@GenTable(name = "easymis_member")
//@GenModel(packageName = "org.easymis.biplatform.designer.entitys.mybatis", modelName = "Member")
public class Member implements Serializable {
	//@GenField(labelname = "", column = "member_id", id = true, length = 40, isnull = false)
	private String memberId;
	//@GenField(labelname = "", column = "org_id", length = 40, isnull = true)
	private String orgId;
	//@GenField(labelname = "用户名|账号", column = "member_name", length = 255, isnull = true)
	private String memberName;
	//@GenField(labelname = "姓名|真实姓名", column = "name", length = 255, isnull = true)
	private String name;
	//@GenField(labelname = "昵称", column = "nickname", length = 100, isnull = true)
	private String nickname;
	//@GenField(labelname = "", column = "password", length = 255, isnull = true)
	private String password;
	//@GenField(labelname = "性别1男0女2保密", column = "gender", isnull = true)
	private Boolean gender;
	//@GenField(labelname = "出生日期", column = "birth", isnull = true)
	private Date birth;
	//@GenField(labelname = "个人介绍", column = "intro", length = 255, isnull = true)
	private String intro;
	//@GenField(labelname = "来自", column = "comefrom", length = 150, isnull = true)
	private String comefrom;
	//@GenField(labelname = "QQ", column = "qq", length = 100, isnull = true)
	private String qq;
	//@GenField(labelname = "电话", column = "phone", length = 50, isnull = true)
	private String phone;
	//@GenField(labelname = "手机", column = "mobile", length = 50, isnull = true)
	private String mobile;
	//@GenField(labelname = "用户个性签名", column = "signature", length = 255, isnull = true)
	private String signature;
	//@GenField(labelname = "证件号码", column = "id_card_no", length = 255, isnull = true)
	private String idCardNo;
	//@GenField(labelname = "会员积分", column = "bp_value", isnull = true)
	private Integer bpValue;
	//@GenField(labelname = "冻结积分", column = "freezed_value", isnull = true)
	private Integer freezedValue;
	//@GenField(labelname = "余额(delete)", column = "balance", isnull = true)
	private Float balance;
	//@GenField(labelname = "现金账户：用户现有资金(余额)", column = "money", isnull = true)
	private Float money;
	//@GenField(labelname = "现金账户：用户冻结资金", column = "frozen_money", isnull = true)
	private Float frozenMoney;
	//@GenField(labelname = "连续签到天数", column = "sign_in_times", isnull = true)
	private Integer signInTimes;
	//@GenField(labelname = "上次签到日期", column = "sign_in_date", isnull = true)
	private Date signInDate;
	//@GenField(labelname = "总签到次数", column = "sign_in_time_all", isnull = true)
	private Integer signInTimeAll;
	//@GenField(labelname = "最后密码修改时间", column = "update_password_time", isnull = true)
	private Date updatePasswordTime;
	//@GenField(labelname = "登录失败次数", column = "login_failure_count", isnull = true)
